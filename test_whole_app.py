...
- Quality: Maintainability, tests, docs or mermaid chart generation only if asked.If ask about mermaid code generation then route to quality agent after Code Analyst.No need to go to other agents for mermaid code generation.
